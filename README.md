...
A production-style **digital wallet REST API** built with **Java Spring Boot 3.4.0**. Users can register accounts, link external bank accounts, perform OTP-verified deposits and withdrawals, and transfer funds between internal wallets. The service integrates with the [Mock Bank API](#integration-with-mock-bank) via HMAC-signed requests.
...
- A running instance of [Mock Bank API](../mock-bank/) (for deposit/withdraw features)
